...
FROM
	...
	hpr_hmi2_20161111.habitaciones h0;
	...
	hmi2guaycuru_camas.servicios_get_id_servicio_sala(
		...
		hmi2guaycuru_camas.servicios_get_id_servicio_estadistica(
			...
			(SELECT
				es0.cod_servicio
			FROM
				hpr_hmi2_20161111.efectores_servicios es0
			WHERE
...
FROM
	...
	hpr_hmi2_20161111.servicios_salas ss
