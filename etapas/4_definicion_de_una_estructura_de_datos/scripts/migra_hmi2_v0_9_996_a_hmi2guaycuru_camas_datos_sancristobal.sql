...
FROM
	...
	scristobal_hmi2_20161028.salas s
...
SELECT
	...
	AND s1.nombre = (
		SELECT
			s0.nombre
		FROM
			scristobal_hmi2_20161028.salas s0
		WHERE
...
FROM
	...
	scristobal_hmi2_20161028.habitaciones h0;
	...
	WHERE
		h1.nombre = (
			SELECT
				h0.nombre
			FROM
				scristobal_hmi2_20161028.camas c0
			INNER JOIN
				scristobal_hmi2_20161028.habitaciones h0
			ON
...
FROM
	...
	scristobal_hmi2_20161028.camas c;
	...
	hmi2guaycuru_camas.servicios_get_id_servicio_sala(
		...
		hmi2guaycuru_camas.servicios_get_id_servicio_estadistica(
			...
			(SELECT
				es0.cod_servicio
			FROM
				scristobal_hmi2_20161028.efectores_servicios es0
			WHERE
...
FROM
	...
	scristobal_hmi2_20161028.servicios_salas ss
