...
module.exports.brandNames = {
  desktop: 'Documentación API - Web Services Centralización de camas críticas Sta. Fe',
  tablet: 'API Docs - WS Camas Críticas Sta. Fe',
  mobile: 'API Docs - WS Camas Críticas'
};
 ...
 */
module.exports.backLink = 'Volver al inicio';
