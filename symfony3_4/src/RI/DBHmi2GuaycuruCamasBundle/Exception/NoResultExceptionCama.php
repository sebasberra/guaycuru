...
/**
 * **Extiende UnexpectedResultException para cama**
 * 
 * Se utiliza esta excepción para identificar los casos donde se realice 
 * una búsqueda de cama y no se encuentre el registro
 * 
 ...
 * 
 */
class NoResultExceptionCama extends UnexpectedResultException{
    
    /**
     * Constructor.
     */
    public function __construct($id_efector, $nombre)
    {
        $msg = 
                'El nombre de cama: ['
                .$nombre.'] '
